...
read_verilog -library xil_defaultlib {{C:/Users/lacze/Desktop/AGH-FPGA-S8/AGH-ZYNQ-S8-2021/__OLD_PROJECTS/ADDER_PROJECTS_STANDARD/2 _ANDY_LOOKAHEAD/EBAZ4205/SOURCE_FILES/bit_shift_module.v}}
...
synth_design -top bit_shift_module -part xc7z010clg400-1 -mode out_of_context

rename_ref -prefix_all bit_shift_module_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef bit_shift_module.dcp
create_report "bit_shift_module_synth_1_synth_report_utilization_0" "report_utilization -file bit_shift_module_utilization_synth.rpt -pb bit_shift_module_utilization_synth.pb"
