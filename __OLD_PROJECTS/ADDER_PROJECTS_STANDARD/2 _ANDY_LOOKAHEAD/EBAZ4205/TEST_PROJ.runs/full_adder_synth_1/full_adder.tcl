...
read_verilog -library xil_defaultlib {{C:/Users/lacze/Desktop/AGH-FPGA-S8/AGH-ZYNQ-S8-2021/__OLD_PROJECTS/ADDER_PROJECTS_STANDARD/2 _ANDY_LOOKAHEAD/EBAZ4205/SOURCE_FILES/full_adder.v}}
...
synth_design -top full_adder -part xc7z010clg400-1 -mode out_of_context

rename_ref -prefix_all full_adder_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef full_adder.dcp
create_report "full_adder_synth_1_synth_report_utilization_0" "report_utilization -file full_adder_utilization_synth.rpt -pb full_adder_utilization_synth.pb"
